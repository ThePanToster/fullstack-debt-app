package com.example.pasir_zabkiewicz_albert.service;

import com.example.pasir_zabkiewicz_albert.dto.DebtDTO;
import com.example.pasir_zabkiewicz_albert.model.*;
import com.example.pasir_zabkiewicz_albert.repository.DebtRepository;
import com.example.pasir_zabkiewicz_albert.repository.GroupRepository;
import com.example.pasir_zabkiewicz_albert.repository.TransactionRepository;
import com.example.pasir_zabkiewicz_albert.repository.UserRepository;
...
public class DebtService {
    ...
    public boolean markAsPaid(Long debtId, User user){
        ...
        if(!debt.getDebtor().getId().equals(user.getId())){
            throw new SecurityException("Nie jesteś dłużniekiem");
        }
